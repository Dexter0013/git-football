...
export default function ScoutForm({
  ...
  return (
    <div className="min-w-0 flex-1">
      ...
      <div className="mb-[18px] inline-flex items-center gap-[9px] rounded-[8px] border border-white/[0.08] bg-white/[0.025] px-[12px] py-[6px] mx-auto">
      ...
      <p className="mb-[26px] max-w-[420px] text-[clamp(15px,1.7vw,18px)] font-medium leading-[1.5] text-ink-dim mx-auto text-center">
      ...
      <form
        onSubmit={submit}
        className="m-0 flex max-w-[460px] w-full flex-wrap gap-[10px] mx-auto justify-center"
      >
        <div className="relative min-w-[200px] flex-1">
          ...
          <input
            ...
            className="font-mono h-14 w-full rounded-[14px] border-[1.5px] border-line bg-surface/70 pl-[34px] pr-5 text-[16px] font-medium text-white outline-none backdrop-blur-[4px] transition focus:border-brand focus:bg-surface focus:shadow-[0_0_0_4px_rgba(0,132,255,.16),0_0_42px_rgba(0,132,255,.24)]"
          />
        </div>
        <button
          type="submit"
          disabled={loading}
          className="font-display group flex h-14 items-center gap-2 rounded-[14px] bg-gradient-to-b from-brand to-brand-mid px-7 text-[20px] tracking-[.06em] text-[#04130a] shadow-[0_0_0_1px_rgba(0,132,255,.4),0_10px_30px_rgba(0,132,255,.3)] transition hover:from-brand-hi hover:to-brand disabled:cursor-wait disabled:opacity-75"
        >
      ...
      {error && (
        <div
          role="alert"
          className="mt-[13px] max-w-[460px] mx-auto rounded-[10px] border border-[#f85149]/30 bg-[#f85149]/10 px-[13px] py-[10px] text-[13.5px] font-medium text-[#ff9d96]"
        >
          {error}
        </div>
      )}
      ...
      <div className="mt-[20px] flex flex-wrap items-center justify-center gap-x-[14px] gap-y-[10px]">
        {scoutCount != null && (
          <>
            ...
            <span aria-hidden className="h-[12px] w-px bg-white/[0.12] hidden" />
          </>
        )}
        <button
          type="button"
