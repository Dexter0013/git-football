    ...
    (
      <div
        style={{
          ...
          background: "#02001e",
          backgroundImage:
            "radial-gradient(900px 520px at 22% -12%, rgba(0,132,255,0.20), transparent 60%), radial-gradient(720px 520px at 105% 120%, rgba(212,175,55,0.14), transparent 60%)",
          color: "#e6edf3",
          fontFamily: "DINPro",
          padding: 72,
          alignItems: "center",
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", flex: 1, height: "100%", paddingRight: 48 }}>
          <div style={{ display: "flex", color: "#0084ff", fontSize: 24, fontWeight: 700, letterSpacing: 3 }}>
            GITHUB × WORLD CUP 26
          </div>
